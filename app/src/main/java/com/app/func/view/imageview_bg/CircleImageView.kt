...
class CircleImageView @JvmOverloads constructor(
    ...
    private fun getDefaultAttributes(attrs: AttributeSet?, defStyle: Int) {
    ...
    init {
        getDefaultAttributes(attrs, defStyleAttr)
