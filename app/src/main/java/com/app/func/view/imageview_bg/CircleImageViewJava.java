...
public class CircleImageViewJava extends ImageView {
    ...
    public CircleImageViewJava(Context context) {
        super(context);

        init();
    }

    public CircleImageViewJava(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleImageViewJava(Context context, AttributeSet attrs, int defStyle) {
