...
class ViewAnimationsActivity2 : BaseActivity() {

    private lateinit var binding: ActivityViewAnimations2Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setLocale("en")
        binding = ActivityViewAnimations2Binding.inflate(layoutInflater)
